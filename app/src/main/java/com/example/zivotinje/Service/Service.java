package com.example.zivotinje.Service;
...
import com.example.zivotinje.MainActivity;
...
public class Service extends android.app.Service {
    ...
    public Service() {
        super();
        System.out.println("****** [Service] in (empty) constructor ...");
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        System.out.println("****** [Service] in onStartCommand ...");
...
//
        ...
        System.out.println("****** [Service] preparing notification resources...");
    ...
    public void heavyWork(){
        System.out.println("****** [Service] in heavyWork: starting infinite loop...");
...
//dohvati popis svi ziv sto pratis
    ...
    public void onDestroy() {
        serviceAlive = false;
        System.out.println("****** [Service] Deleting listeners...");
        //
    ...
    public void updateNotification(Bitmap b){
        ...
        intent.putExtra("oznakan", ziv.getOznaka());
        intent.putExtra("notifikacija","not");

        PendingIntent contentIntent = PendingIntent.getActivity(this, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
        System.out.println("****** [Service] Image received, updating notification with name/surname and image...");
        if (mNotificationBuilder != null) {
            Notification newN = mNotificationBuilder
                    .setContentIntent(contentIntent)
                    .setContentTitle(ziv.getNaziv())
                    .setContentText(ziv.getNaz_skl())
                    .setSubText("Dogodila se promjena")
                    .setLargeIcon(b)
                    .build();
    ...
    private class DownloadImageTask extends AsyncTask<String, Void, Bitmap> {
        ...
        DownloadImageTask() {
            System.out.println("****** [Service] DownloadImageTask: in constructor...");
        }

        @Override
        protected Bitmap doInBackground(String... imageurl) {
            System.out.println("****** [Service] DownloadImageTask in doInBackground: getting image...");
            Bitmap bitmap = null;
            ...
            try {
                ...
                System.out.println("****** [Service] DownloadImageTask in doInBackground: error getting image...");
            }
        ...
        protected void onPostExecute(Bitmap resultImg) {
            System.out.println("****** [Service] DownloadImageTask: in onPostExecute...");
